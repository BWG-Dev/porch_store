...
if(!function_exists('etheme_search')) {
	function etheme_search($atts) {
		...
		// broken and requires some old theme settings - just disable it
		return;
...
function etheme_featured_shortcodes($atts, $content=null){
	...
	// just generate from WooCommerce to avoid any legacy dependencies
	return do_shortcode('[products limit="' . $limit . '" columns="4" visibility="featured"]');
...
// !!! don't add these shortcodes to Tiny MCE anymore !!!

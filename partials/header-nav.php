...
<section id="main-header" class="bp-temp">
	...
	<div class="white-block">
		<div id="logo-block">
			<a href="<?php echo esc_url( home_url() ); ?>"><img class="store-logo" src="<?php echo esc_url( get_template_directory_uri() . '/dist/images/logo-store.png' ); ?>"></a>
		</div>
	...
	<?php if ( $header_subnav ) : ?>
		<div class="brown-block hidesubnav"><?php echo $header_subnav; ?>
		</div>	
	<?php endif; ?>
</section>
